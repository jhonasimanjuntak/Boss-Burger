...
<head>
    ...
    <title>MedReg - Sistem Pendaftaran Online Puskesmas</title>
...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <main class="form-signin w-100 m-auto">
        <form class="needs-validation" novalidate action="proses/proses_register.php" method="post">
            ...
            <h1 class="h3 mb-2 fw-normal text-center">Registrasi Puskesmas Peudada</h1>

            <div class="form-floating">
                <input name="nama" type="text" class="form-control" id="floatingUsername" placeholder="Username"
                    required>
            ...
            <div class="form-floating">
                <input name="username" type="email" class="form-control" id="floatingEmail"
            ...
            <button class="btn btn-success w-100 py-2" type="submit" name="submit_register"
                value="Register">Register</button>
            <form class="needs-validation" novalidate action="proses/proses_register.php" method="post">
            </form>
            <p class="text-center mt-3 mb-0">Anda sudah punya akun? <a href="login.php">Login</a></p>
    </main>
    <script>
